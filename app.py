        ...
        if not df_analysis.empty:
            ...
            if not df_trend_filtered.empty:
                ...
                if is_mobile_view:
                    ...
                    # 📱 모바일 가독성 핵심패치: 글자 유실방지를 위해 막대 안쪽으로 숫자를 강제 배치하고 폰트 속성 보정
                    fig_monthly.update_traces(
                        textposition='inside', 
                        insidetextanchor='middle',
                        textfont=dict(color='white', size=11, family='Pretendard')
                    )
                else:
                ...
                # 🛠️ 가로축 '발생량 (kg)' 타이틀 제거 패치
                if is_mobile_view:
                    fig_monthly.update_xaxes(title_text="", showgrid=True, gridcolor='#E5E5E5', zeroline=False)
                    ...
                    fig_monthly.update_yaxes(title_text="", showgrid=True, gridcolor='#E5E5E5', zeroline=False)
