...
if login():
    ...
    with tab3:
        ...
        if not df_analysis.empty:
            ...
            # 👇 변경된 그래프 로직: x축을 '생산 조'로, 막대 색상을 '년월'로 지정
            fig_monthly = px.bar(monthly_summary, x='생산 조', y='발생량_kg', color='년월',
                                 barmode='group', text_auto='.1f',
                                 title="조별 및 월별 스크랩 발생 현황 (kg 환산)",
                                 labels={'발생량_kg': '발생량(kg)', '생산 조': '조', '년월': '발생 월'},
