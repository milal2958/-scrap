...
st.markdown("""
    ...
    @media (max-width: 768px) {
        ...
        .block-container {
            ...
            padding-top: 0.5rem !important; /* 상단 여백을 줄여 잘림 현상 해결 */
            padding-bottom: 1rem !important;
        }
        /* 상단 빈 공간을 만드는 Streamlit 내부 헤더 숨김 처리 */
    ...
    with tab3:
        ...
        if not df_analysis.empty:
            ...
            if not df_trend_filtered.empty:
                ...
                # 가독성 확보를 위해 가로 차트 스위칭 기준 완화 (데이터 누적 대응)
                ...
                if is_mobile_view:
                    ...
                    fig_monthly = px.bar(
                        ...
                        color_discrete_sequence=px.colors.qualitative.MUTED  # 대문자 MUTED로 수정 완료
                    )
